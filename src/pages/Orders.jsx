...
import { ScrollText, Target, Coins, CheckCircle } from 'lucide-react';
...
const Orders = () => {
  ...
  const fetchOrders = async () => {
    try {
      ...
      toast.error('Davlat buyurtmalarini yuklashda xatolik');
    } finally {
      setLoading(false);
    }
  };
  ...
  const confirmFulfill = async () => {
    if (!fulfillQty || parseInt(fulfillQty) <= 0) return toast.error('Yaroqsiz miqdor');
  ...
  return (
    <div className="p-4 md:p-8 flex-1 overflow-y-auto custom-scrollbar">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <GlassCard className="text-center p-8 bg-gradient-to-br from-blue-900/40 to-transparent border border-blue-800/50">
          <ScrollText className="w-16 h-16 text-blue-400 mx-auto mb-4" />
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-yellow-400 font-black text-lg flex items-center">
                    ...
                    <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-800 mb-6">
                      ...
                      <div className="w-full bg-slate-800 rounded-full h-3">
                        <motion.div 
                          ...
                          className="bg-blue-500 h-3 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.6)]" 
                        />
                      </div>
                      <p className="text-xs text-slate-500 mt-3 flex justify-between">
                        <span>Sizda bor: <span className={myStock > 0 ? 'text-green-400 font-bold' : ''}>{myStock} ta</span></span>
                        <span>Hali kerak: <span className="text-orange-400 font-bold">{remaining} ta</span></span>
                      </p>
                    </div>
          ...
          {modalOpen && selectedOrder && (
            ...
            >
              <motion.div 
                ...
                className="bg-slate-900 border border-slate-700 p-8 rounded-2xl shadow-2xl max-w-sm w-full relative"
              >
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-slate-400">Davlatga yana <span className="font-bold text-blue-400">{selectedOrder.quantity_required - selectedOrder.quantity_fulfilled} ta</span> kerak.</p>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-800 border-slate-700 text-white rounded-xl text-center text-xl font-bold py-3"
                      value={fulfillQty}
                  ...
                  <div className="bg-black/50 p-4 rounded-xl border border-slate-800 text-center">
                    ...
                    <p className="text-2xl font-black text-green-400 flex items-center justify-center">
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    <button onClick={confirmFulfill} disabled={isSubmitting} className="flex-1 bg-green-600 hover:bg-green-500 text-white rounded-xl font-bold py-3 flex justify-center items-center">
